    ...
    */
    ...
    'settings' => [
        'index' => [
            ...
            'webhook_info' => 'Egy discord webhook üzenet elküldésre kerül ha egy új bejegyzés létrejön és annak dátuma nem a jövőbe nyúlik. Hagyd üresen hogy kikapcsold.',
        ],
        ...
        'auth' => [
            ...
            'conditions' => 'A regisztráció során elfogadandó feltételek',
            ...
            'registration_info' => '<strong>A “Regisztráció” gomb el lesz tüntetve ha ez az opció ki van kapcsolva.</strong> Néhány plugin engedélyezheti a regisztrációt.',
            ...
            'user_change_name' => 'Lehetővé teszi a felhasználók számára a fiókjuk törlését a profiljukból.',
            'user_avatar' => 'Lehetővé teszi a felhasználók számára a saját profilkép feltöltését.',
...
',
    ...
    'servers' => [
        ...
        'verify' => 'Azonnali parancsok tesztelése',
        ...
        'azlink' => [
            ...
            'auth' => 'Az automatikus regisztráláshoz a felhasználóknak a weboldalra engedélyezned kell ennek az integrációját a hitelesítő rendszert ellátó pluginban (Authme, stb..) az AzLink konfigurációban.',
            ...
            'command' => 'A szervered össze tudod kötni a következő paranccsal: ',
    ...
    'users' => [
        ...
        '2fa' => [
            ...
            'secured' => 'Kétlépcsős hitelesítés engedélyezve',
            'disable' => '2FA kikapcsolása',
            'disabled' => 'A kétfaktoros bejelentkeztetés ki lett kapcsolva.',
        ],

        'password' => [
            'title' => 'Útolsó jelszó változás',
            'force' => 'Kényszerített változtatás',
            'forced' => 'Meg kell változtatni a jelszót
',
        ],
        ...
        'discord' => 'Linkelt Discord fiók',

        'notify' => 'Értesítés küldése
',
        'notify_info' => 'Értesítés küldése a felhasználónak',
        'notify_all' => 'Értesítés küldése minden felhasználónak',
    ],

    'roles' => [
        'title' => 'Rangok',
        'edit' => ':role (#:id) rang szerkesztése',
        'create' => 'Új rang létrehozása',

        'info' => '(ID: :id, Erősség: :power)',
        ...
        'discord' => [
            'title' => 'Linkelt Discord rangok',
            'enable' => 'Discord rangok összekötésének engedélyezése',
