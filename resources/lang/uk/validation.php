...
return [
    ...
    */
    ...
    'can' => 'Поле :attribute містить неправильне значення.',
    ...
    'date' => 'Поле :attribute має містити правильні дані.',
    'date_equals' => 'Поле :attribute має містити дату й дорівнювати :date.',
    'date_format' => 'Поле :attribute повинно містити формат :format.',
    ...
    'doesnt_end_with' => 'Поле :attribute має закінчуватися одним з наступних значень: :values.',
    ...
    'max_digits' => 'Поле :attribute повинне містити не більше :max елементів.',
    ...
    'min_digits' => 'Поле :attribute має містити принаймні :min елементів.',
    ...
    'present_if' => 'Поле :attribute є обов\'язковим для заповнення, коли :other є :value.',
    'present_unless' => 'Поле :attribute є обов\'язковим для заповнення, крім :other є :value.',
    'present_with' => 'Поле :attribute є обов\'язковим для заповнення, коли :values вказано.',
    'present_with_all' => 'Поле :attribute є обов\'язковим для заповнення, коли :values вказано.',
    ...
    'same' => 'Поле :attribute повинно існувати в :other.',
    'size' => [
