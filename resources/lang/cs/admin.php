    ...
    */
    ...
    'settings' => [
        ...
        'auth' => [
            ...
            'registration_info' => '<strong>Pokud je tato možnost zakázána, bude odstraněno tlačítko „Registrovat“.</strong> Některé doplňky mohou stále umožňovat vytváření nových uživatelských účtů.',
            ...
            'user_avatar' => 'Umožnit uživatelům nahrávat vlastní avatary na svůj profil',
        ...
        'mail' => [
            ...
            'missing' => 'U účtu :user nebyla zadána žádná e-mailová adresa.',
        ],
    ...
    'navbar_elements' => [
        ...
        'dropdown' => 'Po uložení této nabídky do ní lze přidat položky přetažením na hlavní stránce navigační lišty.',
    ...
    'servers' => [
        ...
        'azlink' => [
            ...
            'auth' => 'Chcete-li automaticky registrovat uživatele na webu, můžete povolit integraci vašeho přihlašovacího systému (AuthMe apod.) v nastavení AzLink.',
    ...
    'roles' => [
        ...
        'no_admin' => 'Pro odebrání vaší role správce musí existovat alespoň jeden další uživatel.',
        ...
        'discord' => [
            ...
            'enable_info' => 'Po povolení této možnosti upravte roli na Discordu a na kartě <b>Odkazy</b> přidejte požadavek. Uživatelé mohou získat svoji roli tím, že na Discordu v nabídce serveru vyberou <b>Propojené role</b>.',
            ...
            'oauth' => 'Poté v <b>OAuth2</b> na kartě <b>General</b> musíte do pole <b>Redirects</b> přidat <code>:url</code>.',
    ...
    'extensions' => [
        'buy' => 'Koupit za :price',
        'market' => 'Informace o všech rozšířeních jsou dostupné v <a href=":url" target="_blank" rel="noopener noreferrer">Azuriom Marketu</a>.',
    ],
    ...
    'update' => [
        ...
        'php' => 'Pro aktualizaci této verzi Azuriomu je potřeba PHP :version nebo novější.',
    ],
