...
return [
    ...
    */
    ...
    'delete' => [
        'title' => 'Sil?',
        'description' => 'Silmek istediğinizden emin misin? bu işlem geri alınamayacaktır!',
    ],
...
Google reCAPTCHA web sitesi</a>. ReCAPTCHA kullanmanız gerekiyor <strong>v2 görünmez</strong> anahtarlar.',
        ...
        'auth' => [
            ...
            'registration_info' => '<strong>"Kayıt Ol" butonu bu seçenek devre dışı bırakıldığında kaldırılır.</strong> Bazı eklentiler yine de yeni kullanıcı hesapları oluşturmayı mümkün kılabilir.',
            ...
            'user_avatar' => 'Kullanıcıların profilinde kendi avatarlarını yüklemelerine izin ver',
        ...
        'mail' => [
            ...
            'missing' => ':user hesabında hiçbir e-posta adresi belirtilmemiş.',
        ],
    ...
    'navbar_elements' => [
        ...
        'dropdown' => 'Bu açılır menü kaydedildikten sonra, ana gezinme çubuğu sayfasında sürükle ve bırak yöntemiyle öğeler eklenebilir.',
    ...
    'servers' => [
        ...
        'azlink' => [
            ...
            'auth' => 'Kullanıcıları otomatik olarak siteye kaydetmek için, AzLink yapılandırmasında kimlik doğrulama sisteminizi (AuthMe, vb.) entegre etmeyi etkinleştirebilirsiniz.',
...
',
    ...
    'roles' => [
        ...
        'no_admin' => 'Admin rolünüzü kaldırmak için en az bir başka admin kullanıcısı bulunmalıdır.',
        ...
        'discord' => [
            ...
            'enable_info' => 'Rol etkinleştirildiğinde, Discord\'da rolü düzenleyin ve rolün <b>Bağlantılar</b> sekmesinde bir gereklilik ekleyin. Kullanıcılar, Discord\'da sunucu menüsünde ardından <b>Bağlı Rollere</b> giderek rolü alabilirler.',
            ...
            'oauth' => 'Ardından, Discord\'da <b>OAuth2</b> sekmesinde, <b>Genel</b> bölümünde, <b>Yönlendirmeler</b> alanına <code>:url</code> eklemeniz gerekmektedir.',
    ...
    'extensions' => [
        ...
        'market' => 'Tüm eklentilerle ilgili bilgilere <a href=":url" target="_blank" rel="noopener noreferrer">Azuriom Market</a> üzerinden ulaşabilirsiniz.',
    ],
    ...
    'update' => [
        ...
        'php' => 'Bu Azuriom sürümünü güncellemek için PHP :version veya daha yüksek bir sürümünü kullanmalısınız.',
    ],
