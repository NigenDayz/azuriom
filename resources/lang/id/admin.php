    ...
    */
    ...
    'settings' => [
        'index' => [
            ...
            'webhook' => 'Mengirimkan Link Webhook Discord',
            'webhook_info' => 'Sebuah URL Webhook Discord akan dikirimkan saat membuat postingan baru, jika tanggal publish tidak di jadwalkan. Kosongkan untuk menonaktifkan.',
        ],
        ...
        'security' => [
            ...
            'captcha' => [
                ...
                'recaptcha' => 'Anda bisa mendapatkan kunci reCAPTCHA melalui <a href="https://www.google.com/recaptcha/" target="_blank" rel="noopener noreferrer"> Laman Situs Google reCAPTCHA</a>. Anda harus menggunakan kunci reCAPTCHA <strong>v2 invisible</strong>.',
                ...
                'turnstile' => 'Anda bisa mendapatkan kunci Turnstil melalui <a href="https://dash.cloudflare.com/?to=/:account/turnstile" target="_blank" rel="noopener noreferrer">Dashboard Cloudflare</a>. Anda harus memilih widget "Managed".',
            ],
        ...
        'auth' => [
            ...
            'conditions' => 'Syarat yang harus di setujui saat melakukan pendaftaran',
            'conditions_info' => 'Format Markdown untuk membuat Tautan, sebagai contoh: <code>Saya menyetujui [syarat](/conditions-link) dan [kebijakan privasi](/privacy-policy)</code>.',
            'registration' => 'Aktifkan pendaftaran pengguna',
            'registration_info' => '<strong>Tombol “Register” akan dihilangkan jika opsi ini dinonaktifkan.</strong> Beberapa plugin akan tetap memperbolehkan membuat akun baru.',
            ...
            'user_change_name' => 'Memperbolehkan pengguna mengubah username mereka dari profile pengguna',
            'user_avatar' => 'Memperbolehkan pengguna untuk mengunggah avatar mereka sendiri di profile pengguna',
    ...
    'navbar_elements' => [
        ...
        'dropdown' => 'Setelah dropdown ini di simpan, menu yang lain bisa di tambahkan melalui "drag and drop" melalui halaman navbar utama.',
    ...
    'servers' => [
        ...
        'verify' => 'Mencoba command instan',

        'rcon_password' => 'Rcon Password',
        'rcon_port' => 'Rcon Port',
        'query_port' => 'Sumber Kueri Port',
        'unturned_info' => 'Anda harus menggunakan tipe SRCDS RCON di OpenMod. RocketMod RCON tidak kompatibel!',

        'azlink' => [
            'port' => 'AzLink Port',

            'link' => 'Untuk menghubungkan server anda ke situs web anda menggunakan AzLink:',
            ...
            'auth' => 'Untuk secara otomatis mendaftakarn pengguna di situs web anda, Anda bisa mengaktifkan sistem autentikasi integrasi anda (AuthMe, etc.) di konfigurasi AzLink.',
            ...
            'command' => 'Anda bisa menghubungkan server anda ke situs web anda menggunakan command: ',
    ...
    'users' => [
        ...
        '2fa' => [
            ...
            'secured' => '2FA telah aktif',
            'disable' => 'Nonaktifkan 2FA',
            'disabled' => 'Autentikasi dua faktor telah dinonaktifkan.',
        ],

        'password' => [
            'title' => 'Perubahan kata sandi terakhir',
            'force' => 'Paksa Perubahan',
            'forced' => 'Harus merubah kata sandi',
        ],
        ...
        'discord' => 'Akun Discord yang terhubung',

        'notify' => 'Kirim notifikasi',
        'notify_info' => 'Kirimkan notifikasi ke pengguna ini',
        'notify_all' => 'Kirimkan notifikasi ke semua pengguna',
    ],

    'roles' => [
        'title' => 'Peran',
        'edit' => 'Mengubah role :role (#:id)',
        'create' => 'Buat peran',
        ...
        'no_admin' => 'Setidaknya harus ada satu pengguna admin untuk menghilangkan admin role anda.',
        'delete_default' => 'Peran ini tidak dapat dihapus.',
        'delete_own' => 'Kamu tidak dapat menghapus peranmu sendiri.',

        'discord' => [
            'title' => 'Menghubungkan role Discord',
            'enable' => 'Aktifkan untuk menghubungkan role Discord',
            'enable_info' => 'Setelah di aktifkan, ubah role tersebut di Discord, dan juga di tab <b>Links</b> dari role tersebut, tambahkan persyaratan. Pengguna akan mendapatkan role tersebut setelah bergabung di Discord, di menu server lalu di <b>Linked Roles</b>.',
