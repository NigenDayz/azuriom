...
return [
    ...
    */
    ...
    'settings' => [
        ...
        'security' => [
            ...
            'captcha' => [
                ...
                'recaptcha' => 'Możesz uzyskać klucze reCaptcha na stronie <a href="https://www.google.com/recaptcha/" target="_blank" rel="noopener noreferrer"> Google reCaptcha</a>. Musisz użyć kluczy reCaptcha <strong>v2 invisible</strong>.',
                ...
                'turnstile' => 'Możesz uzyskać klucze Turnstil na dashboardzie <a href="https://dash.cloudflare.com/?to=/:account/turnstile" target="_blank" rel="noopener noreferrer">Cloudflare</a>. Musisz wybrać widżet "Zarządzany/Managed".',
            ],
        ...
        'auth' => [
            ...
            'conditions_info' => 'Linki w formacie Markdown na przykład: <code>Akceptuję [conditions](/conditions-link) i [politykę prywatności](/privacy-policy)</code>.',
            'registration' => 'Włącz rejestrację użytkowników',
            'registration_info' => '<strong>Przycisk "Zarejestruj się" jest usuwany, gdy ta opcja jest wyłączona.</strong> Niektóre wtyczki mogą nadal pozwalać na tworzenie nowych kont użytkowników. 1',
            ...
            'user_avatar' => 'Zezwalaj użytkownikom na przesyłanie własnego awatara w swoim profilu',
        ...
        'mail' => [
            ...
            'missing' => 'Na koncie :user nie podano adresu e-mail.',
        ],
    ...
    'navbar_elements' => [
        ...
        'dropdown' => 'Po zapisaniu tej listy elementów można do niej dodać poprzez przeciągnięcie i upuszczenie na głównej stronie paska nawigacyjnego.',
    ...
    'servers' => [
        ...
        'unturned_info' => 'Musisz użyć SRCDS RCON w OpenMod. RocketMod RCON nie jest kompatybilny!',
        ...
        'azlink' => [
            ...
            'auth' => 'Aby automatycznie rejestrować użytkowników na stronie internetowej, można włączyć integrację systemu uwierzytelniania (AuthMe itp.) w konfiguracji AzLink.',
    ...
    'users' => [
        ...
        'password' => [
            'title' => 'Ostatnia zmiana hasła',
            'force' => 'Wymuś zmianę',
            'forced' => 'Musisz zmienić hasło',
        ],
        ...
        'discord' => 'Połączone konto Discord',

        'notify' => 'Wyślij powiadomienie',
        'notify_info' => 'Wyślij powiadomienie do tego użytkownika',
        'notify_all' => 'Wyślij powiadomienie do wszystkich użytkowników',
    ],

    'roles' => [
        'title' => 'Rangi',
        'edit' => 'Edytuj rangę :role (#:id)',
        'create' => 'Stwórz rangę',
        ...
        'no_admin' => 'Aby usunąć rolę administratora, musi istnieć co najmniej jeden inny użytkownik.',
        ...
        'discord' => [
            ...
            'enable_info' => 'Po włączeniu edytuj rolę na Discordzie i w zakładce <b>Linki</b> roli dodaj wymaganie. Użytkownicy mogą uzyskać swoją rolę poprzez przejście na Discorda, w menu serwera, a następnie w <b>Linked Roles</b>.',
            'info' => 'Musisz utworzyć aplikację w panelu programisty <a href="https://discord.com/developers/applications" target="_blank">Discorda</a> i ustawić <b>Linked Role Verification URL</b> na <code>:url</code>',
            'oauth' => 'Następnie, w karcie <b>OAuth2</b>, w <b>General</b>, musisz dodać <code>:url</code> w <b>Redirects</b>.',
            'token_info' => 'Token bota można uzyskać tworząc bota dla Twojej aplikacji. w karcie <b>Bot</b> po lewej stronie panelu programisty Discorda.',
    ...
    'extensions' => [
        'buy' => 'Kup za :price',
        'market' => 'Informacje na temat wszystkich rozszerzeń są dostępne na stronie <a href=":url" target="_blank" rel="noopener noreferrer">Azuriom Market</a>.',
    ],
    ...
    'update' => [
        ...
        'php' => 'Musisz użyć PHP :version lub wyższej, aby zaktualizować do tej wersji Azuriom.',
    ],
