...
return [
    ...
    */
    ...
    'navbar_elements' => [
        ...
        'dropdown' => '保存此下拉菜单后, 就可以在主导航栏页面上通过拖放的方式将项目添加到下拉菜单中.',
    ...
    'roles' => [
        ...
        'discord' => [
            ...
            'enable_info' => '启用后, 在 Discord 编辑角色, 在角色的 <b>Links</b> 一栏中可添加一系列的要求. 用户可以在 Discord 中通过 服务器菜单中的 <b>Linked Roles</b> 获取角色.',
    ...
    'update' => [
        ...
        'php' => '您必须使用 PHP :version 或更高的版本才能更新到这个 Azuriom 版本.',
    ],
