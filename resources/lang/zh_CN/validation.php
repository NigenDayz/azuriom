...
return [
    ...
    */
    ...
    'date_format' => ':attribute 字段的格式必须符合 :format.',
    ...
    'doesnt_end_with' => ':attribute 不能以这些内容结尾: :values.',
    ...
    'extensions' => ':attribute 必须有以下扩展之一: :values.',
    ...
    'present_if' => '当 :other 是 :value 时, :attribute 字段是必填的.',
    'present_unless' => '除非 :other 为 :value, 否则 :attribute 字段是必填的.',
    'present_with' => '当 :values 已填写时, :attribute 是必填的.',
    'present_with_all' => '当 :values 已填写时, :attribute 是必填的.',
