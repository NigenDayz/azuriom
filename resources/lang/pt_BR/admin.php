...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'emails' => 'Os emails estão desativados. Se um usuário esquecer sua senha, ele não poderá redefini-la. Você pode habilitar emails nas <a href=":url">configurações de email</a>.',
    ],
    ...
    'settings' => [
        ...
        'seo' => [
            'title' => 'Configurações da página inical',
        ...
        'auth' => [
            ...
            'registration_info' => '<strong>O botão “Registrar” é removido quando esta opção é desativada.</strong> Alguns plugins ainda podem permitir a criação de novas contas de usuário.',
            ...
            'user_avatar' => 'Permitir que os usuários carreguem seu próprio avatar no seu perfil',
            'user_delete' => 'Permitir que os usuários excluam sua conta do seu perfil',
        ],

        'mail' => [
            'title' => 'Configurações de e-mail',
            'from' => 'Endereço de email usado para enviar emails.',
            'mailer' => 'Tipo de Email',
            'mailer_info' => 'O Azuriom suporta SMTP e o Sendmail para enviar emails. Você pode encontrar mais informações sobre as configurações de email em nossa <a href="https://azuriom.com/docs" target="_blank" rel="noopener noreferrer">documentação</a>.',
            'disabled' => 'Quando os e-ails estão desativados, usuários não poderão redefinir a sua senha se a esquecerem.',
            ...
            'verification' => 'Ativar verificação de endereço de email do usuário',
            'send' => 'Enviar um email de teste',
    ...
    'navbar_elements' => [
        ...
        'dropdown' => 'Depois que este menu for salvo, os itens podem ser adicionados a ele arrastando-os e soltando na página principal da barra de navegação.',
    ...
    'servers' => [
        ...
        'azlink' => [
            ...
            'auth' => 'Para registrar automaticamente usuários no site, você pode ativar a integração do seu sistema de autenticação (AuthMe, etc.) na configuração do AzLink.',
    ...
    'users' => [
        ...
        'email' => [
            ...
            'verified' => 'Endereço de email verificado',
            'date' => 'Sim, em :date',
    ...
    'roles' => [
        ...
        'no_admin' => 'É necessário haver pelo menos um outro usuário administrador para remover seu papel de administrador.',
        ...
        'discord' => [
            ...
            'enable_info' => 'Quando ativado, edite o cargo no Discord, e na aba <b>Links</b> do cargo, adicione um requerimento. Usuários podem obter seus cargos ao entrar no Discord, no menu do servidor e em seguida no cargo <b>Linked Roles</b>.',
            'info' => 'Você precisa criar um aplicativo no <a href="https://discord.com/developers/applications" target="_blank">Discord developer dashboard</a> e definir o <b>Linked Roles Verification URL</b> para <code>:url</code>',
    ...
    'extensions' => [
        ...
        'market' => 'Informações sobre todas as extensões está disponível no <a href=":url" target="_blank" rel="noopener noreferrer">Azuriom Market</a>.',
    ],
    ...
    'update' => [
        ...
        'php' => 'Você deve usar o PHP :version ou superior para atualizar para esta versão do Azuriom.',
    ],
