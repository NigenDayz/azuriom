...
return [
    ...
    'forums' => [
        ...
        'restricted' => 'Restringir acesso a este fórum apenas a certos cargos',
        ...
        'private_info' => 'Os usuários só podem ver suas próprias discussões e fixas.',
    ...
    'permissions' => [
        ...
        'discussions' => 'Gerenciar as discussões do fórum (mover, editar, excluir, fixar, trancar)',
        'private' => 'Ver discussões de outros usuários em fóruns privados',
        'delete_own_posts' => 'Excluir os próprios posts do fórum',
        'locked' => 'Criar uma discussão em um fórum trancado'
    ],
];
