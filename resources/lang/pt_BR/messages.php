...
return [
    ...
    'profile' => [
        ...
        'avatar' => 'A imagem de perfil deve ser quadrada e ter um tamanho mínimo de :size pixels.',
        ...
        'delete' => [
            ...
            'email' => 'Enviaremos um email de confirmação para confirmar esta operação.',
            'sent' => 'Um link de confirmação foi enviado para o seu endereço de email.',
            'success' => 'Sua conta foi excluída com sucesso!',
        ],

        'email_verification' => 'Seu email não está verificado, por favor, verifique seu email para um link de verificação.',
