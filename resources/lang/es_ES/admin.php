...
',
            ...
            'webhook_info' => 'Un webhook de Discord será enviado a esta URL cuando se cree una nueva publicación, si la fecha de publicación no es en el futuro. Dejar en blanco para desactivar.',
        ],
        ...
        'security' => [
            ...
            'captcha' => [
                ...
                'recaptcha' => 'Puedes obtener claves reCAPTCHA en el <a href="https://www.google.com/recaptcha/" target="_blank" rel="noopener noreferrer">Sitio Web de Google reCAPTCHA</a>. Necesitas usar claves reCAPTCHA<strong>v2 invisibles</strong>.',
                ...
                'turnstile' => 'Puedes obtener las claves Turnstil en el  <a href="https://dash.cloudflare.com/?to=/:account/turnstile" target="_blank" rel="noopener noreferrer">panel de control de Cloudflare</a>. Debe seleccionar el widget "Administrado".',
            ],
        ...
        'auth' => [
            ...
            'conditions_info' => 'Enlaces en formato Markdown, por ejemplo: <code>Acepto las [condiciones](/conditions-link) y la [política de privacidad](/privacy-policy)</code>.',
        ...
        'mail' => [
            ...
            'mailer_info' => 'Azuriom soporta el uso de SMTP y Sendmail para enviar correos. Puedes encontrar más información en la página de configuración de correo en nuestra <a href="https://Azurita.com/docs" target="_blank" rel="noopener noreferrer">documentación</a>.',
            'disabled' => 'Cuando los correos están desactivados, los usuarios no podrán restablecer su contraseña en caso de que la hayan olvidado.',
            ...
            'sent' => 'El correo de prueba ha sido enviado con éxito.',
        ...
        'maintenance' => [
            ...
            'global' => 'Activar el modo mantenimiento del sitio',
            'paths' => 'Sitios a bloquear durante el mantenimiento',
            'info' => 'Puedes utilizar un <code>/*</code> para bloquear todas las páginas que estén en el mismo directorio. Por ejemplo, <code>/news/*</code> bloqueará el acceso a todas las noticias.',
        ],
    ...
    'navbar_elements' => [
        ...
        'restrict' => 'Limitar los roles que podrán ver este botón',
        'dropdown' => 'Una vez que este menú despegable se guarde, los elementos se podrán añadir arrastrando y soltando en la página principal de la barra de navegación.',
        ...
        'updated' => 'Barra de navegación actualizada.',
        'not_empty' => 'No puedes eliminar un menú desplegable con botones.',
    ],
    ...
    'servers' => [
        ...
        'default_info' => 'Se mostrará el número de jugadores conectados del el servidor principal en el sitio si el tema actual lo soporta.',

        'home_display' => 'Mostrar servidor en la página principal',
        'url' => 'Link del botón de unión',
        ...
        'ping_info' => 'El enlace de ping no necesita un plugin, pero no puedes ejecutar comandos con él.',
        'query_info' => 'Con el link de la consulta, no es posible ejecutar comandos en el servidor.',

        'query_port_info' => 'Puede estar vacío si es el mismo que el puerto del juego.',
        ...
        'azlink' => [
            ...
            'link' => 'Para vincular tu servidor a tu página web usando AzLink:',
            ...
            'info' => 'Si estás teniendo problemas con AzLink al usar Cloudflare o un cortafuegos, intenta seguir los pasos en el <a href="https://azuriom.com/docs/faq" target="_blank" rel="noopener norefferer">FAQ</a>.',
            'command' => 'Puedes vincular tu servidor a tu sitio web con el comando: ',
            'port_command' => 'Si está utilizando un puerto AzLink diferente al predeterminado, debes configurarlo con el comando: ',
            ...
            'badresponse' => 'La conexión al servidor ha fallado (código :code), el token no es válido o el servidor está mal configurado. Puedes rehacer el comando de enlace para arreglar esto.',
        ],
    ...
    'users' => [
        ...
        'ban-description' => '¿Estás seguro de que quieres banear a este usuario?',
    ...
    'roles' => [
        ...
        'discord' => [
            ...
            'enable_info' => 'Una vez activado, edite el rol en Discord, y en la pestaña <b>Enlaces</b> del rol, agregue un requisito. Los usuarios pueden conseguir su rol en Discord, en el menú del servidor y luego en <b>Roles Vinculados</b>.',
            ...
            'oauth' => 'Luego, en la pestaña de <b>OAuth2</b>, en <b>General</b>, tienes que añadir <code>:url</code> en las <b>Redirecciones</b>.',
    ...
    'update' => [
        ...
        'php' => 'Debes usar PHP :versión o superior para actualizar a esta versión de Azuriom.',
    ],
